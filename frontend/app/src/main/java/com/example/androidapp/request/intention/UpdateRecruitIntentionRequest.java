...
public class UpdateRecruitIntentionRequest extends BasePostRequest {
    public UpdateRecruitIntentionRequest(Callback callback, String recruitment_id, String recruitment_type, String recruitment_number,
                                         String research_fields, String introduction, String intention_state, File intention_picture) {
        // 设置请求URL
        this.to("/api/intention/update_recruit_intention");
        // 设置请求参数
